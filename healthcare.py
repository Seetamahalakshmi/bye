...
def main():
    ...
    if st.session_state.page == 0:
        ...
        st.header("An apple a day keep the Doctor away")
        ...
        if st.session_state.symptoms == 'Backpain':
            ...
            st.header('REMEDIES')
            st.write('1. A teaspoon or two of honey may cut mucus production and kill germs.')
            st.markdown('<p style="color:yellow;">Do not give honey under 1 year old :</p>',unsafe_allow_html=True)
            ...
            st.header('REASON FOR SHOULDER PAIN')
            ...
            st.write('1.The most common causes of knee pain are related to ageing, injury or repeated stress on the knee.')
            st.write('2.Knee pain can be related to ageing')
            ...
            st.markdown('<p style="color:yellow;">See a doctor immediately if you gad (GENERALIZED ANXIETY DISORDER)fever:</p>',unsafe_allow_html=True)
            st.write('3.Have red, swollen gums or foul-smelling discharge')
            st.write('4.Experience difficulty swallowing or breathing')
            ...
            st.markdown('<p style="color:yellow;">Do not ignore the symptoms of heart attack:</p>',unsafe_allow_html=True)
